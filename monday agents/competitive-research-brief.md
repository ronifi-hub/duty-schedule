...
### Pattern 1: Usage-Capped Free Tier
**Who:** Salesforce, Base44, Airtable, HubSpot (basic), ClickUp

Free forever with a hard cap on credits. Zero friction entry, long evaluation window. Risk: cap too low to reach aha moment.
- Salesforce: ~10,000 free actions. Airtable: 500 credits/editor. Base44: ~33 agent interactions/month. ClickUp: trial AI in Free plan as capped entry point.

### Pattern 2: Time-Boxed Free Trial
**Who:** Intercom (14 days), Microsoft

Full access for a fixed window. Creates urgency. Risk: too short for complex agent setups.
- Intercom: fully self-serve, no credit card required.

### Pattern 3: Outcome-Based Pricing
**Who:** Zendesk, Intercom

Pay only when AI resolves issues autonomously. Aligns cost with value. No work management platform does this yet.
- Zendesk pioneered "outcome-based pricing" in CX, Aug 2024.

### Pattern 4: Tier-Gated Access
**Who:** HubSpot, Asana, ClickUp (Super Agents)

Agents locked behind higher-tier paid plans. Drives upsell, but high friction.
- ClickUp gates Super Agents behind $22/user/mo Everything AI tier.

### Pattern 5: Developer Sandbox
**Who:** Salesforce

Free isolated environment to build and test. Good for technical buyers only.
- Every Salesforce Dev org now includes Agentforce by default.

### Pattern 6: Launch Free, Charge Later (Grace Period)
**Who:** Notion (10 weeks), HubSpot (grace period)

Ship agents free, announce billing date, charge later. Maximizes adoption velocity. Users build dependency before paying.
- Notion: free Feb 24 – May 3, 2026. Usage dashboard during free period. Agents pause gracefully if no credits.
- **This is the emerging dominant strategy for work management platforms.**
